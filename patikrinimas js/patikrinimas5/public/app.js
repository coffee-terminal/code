...
var balls = [];
var ColorBall = /*#__PURE__*/_createClass(function ColorBall(color, number) {
  _classCallCheck(this, ColorBall);
  this.color = color;
  this.number = number;
});
...
var ballsContainer = document.getElementById('ballsContainer');
var renderBalls = function renderBalls(_) {
...
createBtn.addEventListener('click', function () {
  ...
  var newBall = new ColorBall(color, number);
  balls.push(newBall);
  renderBalls();
});
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkpatikrinimas5"] = self["webpackChunkpatikrinimas5"] || [];
